                ...
                <div class="p-6 bg-white dark:bg-gray-800">
                    ...
                    <form action="{{ route('livros.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="autor" name="autor" id="autor" class="form-input mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="editora" name="editora" id="editora" class="form-input mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="ano_publicacao" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ano de Publicação:</label>
                            <input type="ano_publicacao" name="ano_publicacao" id="ano_publicacao" class="form-input mt-1 block w-full" required>
                        </div>
